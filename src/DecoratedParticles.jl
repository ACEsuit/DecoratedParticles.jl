...
abstract type AbstractState end   # is this needed at all? 
...
"""
`struct DState`: A `State`-like variable but acting like a vector with arithmetic 
...
"""
change how many digits are printed in the `State` output 
"""
